 ...
 *
 * PhiFo : recupération du projet controllers_tech et très légère adaptation pour
 *
 */
...
typedef enum {
    RFID_MFRC522_OK = 0,
    RFID_MFRC522_NOTAGERR,
    RFID_MFRC522_ERROR,
    RFID_MFRC522_TIMEOUT,
...
RFID_MFRC522_Status_t MFRC522_Anticoll(MFRC522_t *dev, uint8_t *uid);
RFID_MFRC522_Status_t MFRC522_ReadUid(MFRC522_t *dev, uint8_t *uid);
